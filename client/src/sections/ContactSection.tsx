  ...
  return (
    <div className="px-4 md:px-16 lg:px-24 xl:px-32" id="contact-us">
      <SectionTitle
        ...
        text3="If you find any bugs or want new features. Just ask we'll try to fulfill your requests. ASAP."
      />
      <form
      ...
      >
        ...
        >
          ...
          <textarea
            ...
            className="focus:border-blue-500 resize-none w-full p-3 outline-none rounded-lg border border-slate-700"
          />
        </motion.div>
