...
const Login = () => {
  ...
  // Google Login - must use the PROXY path so cookies are set on the frontend domain
  const googleLogin = () => {
    window.location.href = "/api/v1/googleOAuth/login";
  };
    ...
    <>
      ...
      <div className="min-h-screen flex justify-center items-center ">
        ...
        >
          ...
          <div className=" flex items-center mt-4 mb-4 w-full bg-white/5 ring-2 ring-white/10 focus-within:ring-pink-500/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all ">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="14"
              height="14"
          ...
          >
            ...
            <span className="text-pink-600 hover:underline hover:text-pink-400 transition-all ml-1">
              click here
            </span>
          </p>
        </form>
